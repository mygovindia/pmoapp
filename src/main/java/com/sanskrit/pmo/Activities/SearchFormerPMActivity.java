...
import com.sanskrit.pmo.Adapters.SearchFormerPMAdapter;
...
public class SearchFormerPMActivity extends BaseActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    private SearchFormerPMAdapter searchAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.searchAdapter = new SearchFormerPMAdapter(this, this.results);
    ...
    private void doSearch(final int page) {
        ...
        MygovClient.getInstance(this).searchFormerPM(this.queryString, PreferencesUtility.getLanguagePrefernce(this), String.valueOf(page), new GenericCallback() {

...
import com.sanskrit.pmo.Adapters.SearchGalleryAdapter;
import com.sanskrit.pmo.Adapters.SearchTrackRecordAdapter;
import com.sanskrit.pmo.R;
import com.sanskrit.pmo.Session.PreferencesUtility;
import com.sanskrit.pmo.network.mygov.MygovClient;
import com.sanskrit.pmo.network.mygov.callbacks.GallerySearchResponse;
...
public class SearchGalleryActivity extends BaseActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    private SearchGalleryAdapter searchAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.rvSearch.setLayoutManager(sgm);
        this.searchAdapter = new SearchGalleryAdapter(this, this.results);
    ...
    private void doSearch(final int page) {
       // searchAdapter.clearAdapter();
        ...
        MygovClient.getInstance(this).searchGallery(this.queryString, PreferencesUtility.getLanguagePrefernce(this), String.valueOf(page), new GenericCallback() {

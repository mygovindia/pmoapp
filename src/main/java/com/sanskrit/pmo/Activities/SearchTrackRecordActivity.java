...
public class SearchTrackRecordActivity extends BaseActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    private SearchTrackRecordAdapter searchAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.searchAdapter = new SearchTrackRecordAdapter(this, this.results);
    ...
    private void doSearch(final int page) {
        ...
        MygovClient.getInstance(this).searchTrackRecord(this.queryString, PreferencesUtility.getLanguagePrefernce(this), String.valueOf(page), new GenericCallback() {

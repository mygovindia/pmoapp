...
public class SearchQuotesActivity extends BaseActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    private void doSearch(final int page) {
        ...
        MygovClient.getInstance(this).searchQuotes(this.queryString, PreferencesUtility.getLanguagePrefernce(this), String.valueOf(page), new GenericCallback() {

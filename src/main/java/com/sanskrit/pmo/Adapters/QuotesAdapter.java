...
public class QuotesAdapter extends RecyclerView.Adapter<QuotesAdapter.ViewHolder> {
    ...
    public QuotesAdapter(AppCompatActivity context, List<Post> posts) {
        this.context = context;
        this.posts = posts;
    }

    public QuotesAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new QuotesAdapter.ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_quotes, viewGroup, false));
    }

    public void onBindViewHolder(QuotesAdapter.ViewHolder viewHolder, int i) {

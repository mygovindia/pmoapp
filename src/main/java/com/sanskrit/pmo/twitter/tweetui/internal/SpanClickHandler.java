...
import com.sanskrit.pmo.twitter.tweetui.internal.HighlightedClickableSpan;

/**
 * A helper class that enables support for clicks on spans in a the text of a
 * {@link TextView} or a {@link Layout}. The text in the layout must
...
public class SpanClickHandler {
     ...
     * {@link #handleTouchEvent(MotionEvent)}.
     */

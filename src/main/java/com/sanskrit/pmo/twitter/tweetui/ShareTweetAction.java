...
class ShareTweetAction implements View.OnClickListener {
    ...
    void onClick(Context context, Resources resources) {
        ...
        final String shareText = resources.getString(com.sanskrit.pmo.R.string.tw__share_tweet);
    ...
    String getShareContent(Resources resources) {
        return resources.getString(com.sanskrit.pmo.R.string.tw__share_content_format,
                tweet.user.screenName, tweet.id);
    }

    String getShareSubject(Resources resources) {
        return resources.getString(com.sanskrit.pmo.R.string.tw__share_subject_format, tweet.user.name,

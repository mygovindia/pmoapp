...
import com.sanskrit.pmo.twitter.core.internal.scribe.EventNamespace;
import com.sanskrit.pmo.twitter.core.internal.scribe.ScribeItem;
import com.sanskrit.pmo.twitter.core.internal.scribe.SyndicatedSdkImpressionEvent;
import com.sanskrit.pmo.twitter.core.internal.scribe.SyndicationClientEvent;
...
class TweetScribeClientImpl implements TweetScribeClient {
    ...
    static EventNamespace getTfwUnretweetNamespace() {
        return new EventNamespace.Builder()
                .setClient(SyndicationClientEvent.CLIENT_NAME)
                .setPage(TFW_CLIENT_EVENT_PAGE)
                .setSection(TFW_CLIENT_EVENT_SECTION)
    ...
    static EventNamespace getTfwRetweetNamespace() {
        return new EventNamespace.Builder()
                .setClient(SyndicationClientEvent.CLIENT_NAME)
                .setPage(TFW_CLIENT_EVENT_PAGE)
                .setSection(TFW_CLIENT_EVENT_SECTION)

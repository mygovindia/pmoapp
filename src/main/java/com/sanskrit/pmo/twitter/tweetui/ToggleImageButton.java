...
public class ToggleImageButton extends ImageButton {
    private static final int[] STATE_TOGGLED_ON = {com.sanskrit.pmo.R.attr.state_toggled_on};
    ...
    public ToggleImageButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            a = context.getTheme().obtainStyledAttributes(attrs,
                    com.sanskrit.pmo.R.styleable.ToggleImageButton, defStyle, 0);
            final String contentDescriptionOn =
                    a.getString(com.sanskrit.pmo.R.styleable.ToggleImageButton_contentDescriptionOn);
            final String contentDescriptionOff =
                    a.getString(com.sanskrit.pmo.R.styleable.ToggleImageButton_contentDescriptionOff);
            ...
            toggleOnClick = a.getBoolean(com.sanskrit.pmo.R.styleable.ToggleImageButton_toggleOnClick, true);

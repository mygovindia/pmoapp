...
import com.sanskrit.pmo.twitter.core.internal.UserUtils;
import com.sanskrit.pmo.twitter.core.internal.VineCardUtils;
import com.sanskrit.pmo.twitter.core.internal.scribe.ScribeItem;
import com.sanskrit.pmo.twitter.core.models.Card;
import com.sanskrit.pmo.twitter.core.models.ImageValue;
...
import com.sanskrit.pmo.twitter.tweetui.internal.MediaBadgeView;
import com.sanskrit.pmo.twitter.tweetui.internal.SpanClickHandler;
import com.sanskrit.pmo.twitter.tweetui.internal.TweetMediaUtils;
import com.sanskrit.pmo.twitter.tweetui.internal.TweetMediaView;
...
public abstract class BaseTweetView extends LinearLayout {
    ...
    BaseTweetView(Context context, int styleResId) {
        this(context, styleResId, new DependencyProvider());
    }
     ...
     * @param attrs              the attributes of the XML tag that is inflating the TweetView
     * @param dependencyProvider the dependency provider
     * @throws IllegalAccessError if the Tweet id is invalid
     */
     ...
     *
     * @throws IllegalStateException If there is no auth configured for the Twitter API
     */
    ...
    final void setTweetMedia(Tweet displayTweet) {
        ...
        if (displayTweet.card != null && VineCardUtils.isVine(displayTweet.card)) {
            ...
            Log.v("TWITTER_IMAGE","Inside  displayTweet");
            Log.v("TWITTER_IMAGE",imageValue!=null?"Image Value is not null":"Image Value is null");
            if (imageValue != null) {
            ...
            Log.v("TWITTER_IMAGE","hasSupportedVideo");
            ...
            Log.v("TWITTER_IMAGE","Inside hasPhoto");
    ...
    void setMediaImage(String imagePath, double aspectRatio) {
        Log.v("TWITTER_IMAGE","URL: "+imagePath);
        final Picasso imageLoader = dependencyProvider.getImageLoader();

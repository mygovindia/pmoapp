...
import com.sanskrit.pmo.twitter.tweetui.internal.MultiTouchImageView;
...
public class GalleryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sanskrit.pmo.R.layout.tw__gallery_activity);

        final MediaEntity entity = (MediaEntity) getIntent().getSerializableExtra(MEDIA_ENTITY);
        final MultiTouchImageView imageView = (MultiTouchImageView) findViewById(com.sanskrit.pmo.R.id.image_view);

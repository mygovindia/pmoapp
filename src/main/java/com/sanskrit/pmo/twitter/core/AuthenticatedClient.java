...
import com.sanskrit.pmo.twitter.core.internal.TwitterRequestHeaders;
 ...
 * additionally adds header signing via {@link Session}
 */
public class AuthenticatedClient extends DefaultClient {
    ...
    /**
     * Parse the {@link FormUrlEncodedTypedOutput} Body from a request into a

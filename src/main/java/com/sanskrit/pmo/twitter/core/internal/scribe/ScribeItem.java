...
public class ScribeItem implements Serializable {
    ...
    static MediaDetails createMediaDetails(long tweetId,
    ...
    static MediaDetails createCardDetails(long tweetId, Card card) {
        return new MediaDetails(tweetId, MediaDetails.TYPE_VINE,
    ...
    static int getMediaType(MediaEntity mediaEntity) {
        if (MediaDetails.GIF_TYPE.equals(mediaEntity.type)) {
            return MediaDetails.TYPE_ANIMATED_GIF;
        } else {
            return MediaDetails.TYPE_CONSUMER;
        }
    }

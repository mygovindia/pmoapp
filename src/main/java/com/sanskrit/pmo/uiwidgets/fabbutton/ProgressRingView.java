...
public class ProgressRingView extends View implements FabUtil.OnFabValueCallback {
    ...
    protected void init(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CircleImageViewFabButton, defStyle, 0);
        mProgress = a.getFloat(R.styleable.CircleImageViewFabButton_android_progress, 0f);
        mProgressColor = a.getColor(R.styleable.CircleImageViewFabButton_fbb_progressColor, mProgressColor);
        mMaxProgress = a.getFloat(R.styleable.CircleImageViewFabButton_android_max, 100f);
        ...
        mAnimDuration = a.getInteger(R.styleable.CircleImageViewFabButton_android_indeterminateDuration, 4000);
        mRingWithRatio = a.getFloat(R.styleable.CircleImageViewFabButton_fbb_progressWidthRatio, mRingWithRatio);
        a.recycle();
